...
- (void)keyboardDidShow:(NSNotification *)notification {
    ...
    [_webView evaluateJavaScript:[NSString stringWithFormat:@"window.scrollTo(0, %@);", [@(keyboardFrame.size.height) stringValue]] completionHandler:nil];
...
- (void)keyboardWillHide:(NSNotification *)notification {
    ...
    [_webView evaluateJavaScript:@"window.onKeyBoard({visible:false, height:0});" completionHandler:nil];
}
...
-(void) callApiMethod: (NSString*) methodName : (NSString*)data;{
    NSLog(@"INF: %@",[NSString stringWithFormat:@"window.jivo_api.%@(%@);",methodName,data]);
    [_webView evaluateJavaScript:[NSString stringWithFormat:@"window.jivo_api.%@(%@);",methodName,data] completionHandler:nil];
